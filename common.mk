...
LD := ld$(CONFIG_LLVM_VER)
CC := clang-$(CONFIG_LLVM_VER)
CXX := clang++-$(CONFIG_LLVM_VER)
CPP := cpp$(CONFIG_LLVM_VER)
LEX := flex
YACC := bison
...
COMPILE.c = $(CC) $(CFLAGS) $(CPPFLAGS) -c -o $@ $< $(OMP)
COMPILE.cc = $(CXX) $(CXXFLAGS) $(CPPFLAGS) -c -o $@ $< $(OMP)
LINK.c = $(CC) $(LDFLAGS) -o $@ $^ $(LDLIBS) $(OMP)
LINK.cc = $(CXX) $(LDFLAGS) -o $@ $^ $(LDLIBS) $(OMP)
